    ...
    <div class="login-container">
      <div class="login-image" :style="{ 'background-image': 'url(' + loginBackground + ')' }">
        <div class="photo-credit">
          <h4>Baucampus - FEOS FZCO</h4>
          <span>Photo by Oskar Lohse</span>
        </div>
      </div>
      <div class="login-content">
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
          ...
          <div class="title-wrap">
            <img class="logo" alt="Laravue" :src="logo">
            <h3 class="title">
              {{ $t('login.title') }}
          ...
          <el-form-item prop="password">
            ...
            <el-input v-model="loginForm.password" name="password" auto-complete="on" placeholder="password"
              :type="pwdType" @keyup.enter.native="handleLogin" />
